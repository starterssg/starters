...
function sendEmail(email,name,firstname){
	...
	text: "Hi " + firstname + ",\n\nThanks for signing up with us for a Starter. We're searching high and low for people who we think you and your friends will enjoy kicking the night off with, so please bear with us while we work our mojo. Remember that you need to bring TWO of your best buddies in order to get matched. We posted the invite link below for you to share with your friends. We added a couple extra invites too, in case you needed some backup ;) \n\n\nwww.starters-singapore.com/invite?name=" + name + "&id=" + hash + "\n\n\nWe'll contact you as soon as everything is set up. Thanks for signing up " + firstname + ", and please feel free to reach out to me personally if there's anything on your mind. Enjoy! \n\nRegards,\nGeoffrey Tsui\nStarters Singapore\ngeoffrey@starters-singapore.com\n+65 91759342",
